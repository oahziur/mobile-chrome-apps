...
public class ChromeBluetooth extends CordovaPlugin {
  ...
  private Set<String> getUuidStringsFromDevice(BluetoothDevice device) {
  ...
  private Set<String> getUuidStringsFromLeScanRecord(ScanRecord scanRecord) {
    Set<String> uuidStrings = new HashSet<>();
  ...
  private JSONObject getDeviceInfo(ScanResult leScanResult) throws JSONException {
    ...
    Set<String> uuidStrings = getUuidStringsFromDevice(leScanResult.getDevice());
    Set<String> adUuidStrings = getUuidStringsFromLeScanRecord(leScanResult.getScanRecord());
